...
- [[Blog](https://openai.com/index/how-confessions-can-keep-language-models-honest/)]
  **LLM Confessions**. Basically, it’s shown that LLMs can retroactively
  “confess” about mistakes they made during some task inference, and another LLM
  can jump in and label the quality of these confessions. These labels are shown
  to be helpful for improving the quality of confessions. Notice that it doesn’t
...
- [[Paper](https://arxiv.org/abs/2503.16527)] **Synthetic customer personas**.
  The idea of using LLMs to generate customer profiles could sound appealing
  because it is cheap, but is shown to lead to many unintended pitfalls in
...
- [[Survey](https://arxiv.org/abs/2512.04123)] **Measuring Agents in
  Production**. Simple yet effective methods drive most successful agents in 2025.
  These agents generally have bounded autonomy, are based on vanilla proprietary
